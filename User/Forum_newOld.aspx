<%@ Page Language="C#" AutoEventWireup="true"  MaintainScrollPositionOnPostback="false" EnableEventValidation="false"  CodeFile="Forum_newOld.aspx.cs" Inherits="User_pro"  %>
      ...
      <!-- START WIDGETS -->
        <div id="page-content">
                ...
                <div class="block">
                    ...
                    <!-- Forum Tabs Title -->
                            <button type="button" id="btnAddTopic" class="btn btn-sm btn-primary" style="float: right; margin-right: 35px;position: relative; top: -14px;"
                                onclick="return ResetForm();">
                                ADD TOPIC</button>

<div class="slideBottomTopic" id="slideBottomTopic" style="height:0px;">
                    <form id="form_Topic"  runat="server"   enctype="multipart/form-data" class="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group">
                                                        <asp:TextBox id="txtTitle" name="txtTitle" class="form-control" runat="server" placeholder="Enter Title..."
                                                            style="width: 200px;" type="text" ></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
											 <div class="form-group">
                                                ...
                                                <div class="col-md-3" style="width: 240px;">
                                                    <asp:DropDownList runat="server" id="cmb_Categories1" name="cmb_Categories1" class="select-chosen" style="width: 300px;">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12 control-label" for="text-input">
                                                    Description:</label>
                                                <div class="col-md-12">
                                                   
                                                      <CKEditor:CKEditorControl ID="txtDesc" name="txtDesc" BasePath="/ckeditor/" runat="server"></CKEditor:CKEditorControl>
                                                     <br />
                         ...
                         <asp:Button type="button" id="BtnSaveTopicr"  runat="server" Text="Save"  class="btn btn-sm btn-primary" OnClick="BtnSaveTopicr_Click"></asp:Button>
                    ...
                    <div class="block-title">
                        <ul class="nav nav-tabs" data-toggle="tabs" id="tabs">
                            <li><a id="Topics-a" class="enable-tabs active" href="#forum-topics" onclick="javascript:varCategoryID=-1;FillCategoryComboFilter();">Topics</a></li>
