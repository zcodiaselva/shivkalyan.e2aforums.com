<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TechTipsAdmin.aspx.cs" Inherits="User_pro" %>
    ...
    <!-- PAGE CONTENT WRAPPER -->
         ...
         <div class="search-area-wrapper">
            <div class="search-area container">
                ...
                <p class="search-tag-line">Assign & Approve user for Tech Tip submission.</p>
...
<div class="panel-body">
                            ...
                            <div class="panel panel-default tabs">
                                <ul class="nav nav-tabs nav-justified">
                                    <li class="active"><a href="#techTip" data-toggle="tab">Assign Tech Tip</a></li>
                                    <li><a href="#approveTechTip" onclick="TechTipsApproveSearch();" data-toggle="tab">Approve Tech Tips</a></li>
                                </ul>
                                ...
                                <div class="panel-body list-group list-group-contacts scroll" style="height:300px">                                
                                 <div id="AssignTechTipsMemberList">
