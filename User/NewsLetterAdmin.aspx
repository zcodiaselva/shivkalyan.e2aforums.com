<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsLetterAdmin.aspx.cs" Inherits="User_pro" %>
    ...
    <!-- PAGE CONTENT WRAPPER -->
         <div class="search-area-wrapper">
            <div class="search-area container">
                ...
                <p class="search-tag-line">Assign & Approve user for Newsletter submission.</p>
...
<div class="panel-body">
                            ...
                            <div class="panel panel-default tabs">
                                <ul class="nav nav-tabs nav-justified">
                                    <li class="active"><a href="#techTip" onclick="searchByNameAdmin()" data-toggle="tab">Assign Newsletter</a></li>
                                    <li><a href="#approveTechTip" onclick="return newsLetterApproveSearch();" data-toggle="tab">Approve Newsletters</a></li>
                                </ul>
                                ...
                                <div class="panel-body list-group list-group-contacts scroll" style="height:300px">                                
                                 <div id="AssignNewsLetterMemberList">
