<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsLetter.aspx.cs" Inherits="User_pro" %>
...
<div class="page-content">
    ...
    <!-- side Menu Control End  -->
     <div class="page-content-wrap bgn"> 
      ...
      <h2><i class="fa fa-book"></i> Newsletter
      </h2>

     <button id="addPost" onclick="return newsLetterGetMy();" class="btn btn-success btn-condensed addPost pull-right"><i class="fa fa-plus"></i> Add Post</button>
    </div>
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          <div class="col-md-12">
                            ...
                            <span class="help-block">NewsletterFile</span> </div>
                        </div>
                      </div>
                      <div class="col-md-8">
                        <div class="form-group">
                          <div class="col-md-12">
                            <div class="input-group"> <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                              <input id="newsLetterFileHeading" class="form-control" type="text">
                            </div>
                            <span class="help-block">Enter Group Name</span> </div>
                        </div>
                      </div>
                      <div class="col-md-2">
                        <button onclick="return newsLetter_send()" class="btn btn-success btn-block"><span class="fa fa-refresh"></span> Create</button>
                      </div>
                    </div>
...
<div class="scroll" style="height: 230px; padding-top:30px;"> 
    ...
    <div class="row">
      <div id="NewsLetterGetAll" class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <div class="form-group">
                          <div class="col-md-12">
                            <div class="input-group"> <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                              <input id="txt_editnn_heading" class="form-control" type="text">
                            </div>
                            <span class="help-block">Enter Group Name</span> </div>
                        </div>
                      </div>
                      <div class="col-md-2">
                        <button onclick="return newsLetter_info_update()" class="btn btn-success btn-block"><span class="fa fa-refresh"></span>Update</button>
                      </div>
                    </div>
...
<!-- END Footer Box --> 
 ...
 <!-- Scroll to top link, initialized in js/app.js - scrollToTop() -->
    <a href="#" id="to-top"><i class="fa fa-angle-double-up"></i></a>
        ...
        <script src="PagesJs/newsletter.js" type="text/javascript"></script>
    ...
    <script type="text/javascript" >
        ...
        newsLetterMemberAssignCheck('<%=UseIDCurent%>');
        newsLetterGetAll();
    </script>
