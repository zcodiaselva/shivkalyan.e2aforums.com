<%@ Page Language="C#" AutoEventWireup="true"  MaintainScrollPositionOnPostback="false" CodeFile="index.aspx.cs" Inherits="User_pro" %>
    ...
    <div class="page-content-wrap"> 
      ...
      <div class="row">
        <div class="col-md-3"> 
          ...
          <!-- START WIDGET FORUMS -->
          <div class="widget widget-default widget-item-icon forums-counter"  onclick="window.location.href='Forum_new.aspx';">
        ...
        <div class="col-md-3"> 
          ...
          <div class="widget widget-default widget-item-icon messages-counter chat-box-button" >
        ...
        <div class="col-md-3"> 
          ...
          <div class="widget widget-default widget-item-icon events-counter" onclick="window.location.href='CalendarEvents.aspx';">
      ...
      <div class="row">
        <div class="col-md-8"> 
          ...
          <!-- START SALES BLOCK -->
          <div class="panel panel-default" id="salesTab">
            <div class="panel-heading">
              ...
              <ul class="panel-controls panel-controls-title">
                ...
                <li><a id="salesTabClick" href="#salesTab" class="panel-fullscreen rounded"><span class="fa fa-expand"></span></a></li>
              </ul>
            </div>
              ...
              <div class="row stacked">
                <div class="col-md-4">
                  <div class="progress-list">
                    ...
                    <div class="pull-right"> <span id="TotalCustOpen" ></span>/<span class="totalCust"></span></div>
                  ...
                  <div class="progress-list">
                    ...
                    <div class="pull-right"><span id="TotalCustPre" ></span>/<span class="totalCust"></span></div>
                    <div class="progress progress-small progress-striped active">
                  ...
                  <div class="progress-list">
                    ...
                    <div class="pull-right"><span id="TotalCustQualified" ></span>/<span class="totalCust"></span></div>
                    <div class="progress progress-small progress-striped active">
                  ...
                  <div class="progress-list">
                    ...
                    <div class="pull-right"><span id="TotalCustDisqualified" ></span>/<span class="totalCust"></span></div>
                    <div class="progress progress-small progress-striped active">
                    ...
                    <div class="pull-right"><span id="TotalCustClosed" ></span>/<span class="totalCust"></span></div>
                    <div class="progress progress-small progress-striped active">
...
<div class="random-facts">
  ...
  <p id="quote"></p>
        ...
        <div class="panel panel-default display-none">
          ...
          <div class="panel-body panel-body-table" onclick="window.location.href='Forum_new.aspx'">
    ...
    <div class="row">
      <div class="col-md-6"> 
        ...
        <!-- START PROJECTS BLOCK -->
        <div class="panel panel-default" id="postTab">
          <div class="panel-heading">
            <div class="panel-title-box">
              <h3>Your Posts</h3>
              <span>Projects activity</span> </div>
            <ul class="panel-controls" style="margin-top: 2px;">
              <li><a href="#postTab" id="postTabClick" class="panel-fullscreen"><span class="fa fa-expand"></span></a></li>
              <li><a href="#" class="panel-refresh"><span class="fa fa-refresh"></span></a></li>

            </ul>
          </div>

          <div class="panel-body panel-body-table" style="cursor:pointer;">
      ...
      <div class="col-md-6"> 
        ...
        <!-- START PROJECTS BLOCK -->
        <div class="panel panel-default" id="newsFeedTab" style="float:left;">
          <div class="panel-heading">
            <div class="panel-title-box">
              <h3>News Feed (RSS)</h3>
            ...
            <ul class="panel-controls" style="margin-top: 2px;">
              <li><a href="#newsFeedTab" class="panel-fullscreen scrollToDiv"><span class="fa fa-expand"></span></a></li>
              <li><a href="#" class="panel-refresh"><span class="fa fa-refresh"></span></a></li>
            </ul>
            </div>
    ...
    function BindGridView() {
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.d.length > 0) {
                    $("#grdDemo").empty();
                    $("#grdDemo").append("<tr><th>Topics</th>  <th>Replies</th>  <th>Views </th>    <th>Last Post</th></tr>");
                    for (var i = 0; i < data.d.length; i++) {
                        $("#grdDemo").append("<tr><td>" +
 " <a onclick=\'return ShowTopicNotification(" + data.d[i].TopicID + ",\" " + data.d[i].Topic + " \", " + data.d[i].CategoryID + ",1);\' style=\"text-decoration:none;\" title=\"\" data-toggle=\"tooltip\" href=\"#\" data-original-title=\"View " + data.d[i].Topic + "\">" +

                        "<b>" + data.d[i].Topic + "</b> <br>" + data.d[i].Description + "</a></td> <td>" +
                        data.d[i].Replies + "</td> <td>" +
                         data.d[i].TopicView + "</td> <td>" +
                        data.d[i].LastPostUser + "</td></tr>");

                    }
                }
                else {
                    ("#grdDemo").append("<tr><td>No post by You</td></tr>");
                }
...
<script>
 ...
 jQuery(document).on('click', '.scrollToDiv', function(e) {
        // target element id
