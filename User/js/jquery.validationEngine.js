    ...
    $.fn.validationEngine = function (settings) {
        ...
        if ($.validationEngineLanguage) {				// IS THERE A LANGUAGE LOCALISATION ?
            ...
            allRules = { "required": {    			// Add your regex rules here, you can take telephone as an example
                ...
                "confirm": {
                    "regex": "none",
                    "alertText": "* Confirm password not same"
                },
                "telephone": {
                    "regex": "/^[0-9\-\(\)\ ]+$/",
                ...
                "UserNameExists": {
                    "file": "../Validation/Validate.aspx?Mode=CHECKUSERNAME",
                    "alertTextOk": "* This email is available",
                    "alertTextLoad": "* Loading, please wait",
                    "alertText": "* This email is already registered"
                },
                "EmailExistence": {
                    "file": "../Validation/Validate.aspx?Mode=CHECKEMAILEXISTS",
                    "alertTextOk": "* This email is available",
                    "alertTextLoad": "* Loading, please wait",
                    "alertText": "* This email is already registered"
                },
                "ajaxUserEmail": {
                    "file": "../User/Ajax/CommonAjax.aspx?Mode=VALIDATEUSEREMAIL",
                    "alertTextOk": "* This user is available",
                    "alertTextLoad": "* Loading, please wait",
                    "alertText": "* This Email is already taken"
                },
                "ajaxUserEmailOnSignUp": {
                    "file": "User/Ajax/CommonAjax.aspx?Mode=VALIDATEUSEREMAIL",
                    "alertTextOk": "* This user is available",
                    "alertTextLoad": "* Loading, please wait",
                    "alertText": "* This Email is already taken"
                },
                "ajaxClinicCodeExistence": {
                    "file": "../User/Ajax/CommonAjax.aspx?Mode=VALIDATECLINICCODE",
                    "alertTextOk": "* This user is available",
                    "alertTextLoad": "* Loading, please wait",
                    "alertText": "* This Clinic code is already taken"
                },
                "ajaxClinicCodeExistenceOnSignUp": {
                    "file": "User/Ajax/CommonAjax.aspx?Mode=VALIDATECLINICCODE",
                    "alertTextOk": "* This user is available",
                    "alertTextLoad": "* Loading, please wait",
                    "alertText": "* This Clinic code is already taken"
                },	
                  "ajaxClinicnameExistence": {
                    "file": "../User/Ajax/CommonAjax.aspx?Mode=VALIDATECLINICNAME",
                    "alertTextOk": "* This user is available",
                    "alertTextLoad": "* Loading, please wait",
                    "alertText": "* This Clinic name is already taken"
                },
                "ajaxClinicnameExistenceOnSignUp": {
                    "file": "User/Ajax/CommonAjax.aspx?Mode=VALIDATECLINICNAME",
                    "alertTextOk": "* This user is available",
                    "alertTextLoad": "* Loading, please wait",
                    "alertText": "* This Clinic name is already taken"
                    ...
                    "ajaxCheckPassword": {
                    "file": "User/Ajax/Validate.aspx?Mode=CHECKPASSWORD",
                    "alertTextOk": "* Wrong Password ",
                    "alertTextLoad": "* Loading, please wait",
                    "alertText": "* Wrong Password"
                },

                "EmailValidate": {
                    "file": "../Validation/Validate.aspx?Mode=EMAILVALIDATE",
                    "alertTextOk": "* Invalid email address ",
                    "alertTextLoad": "* Loading, please wait",
                    "alertText": "* Invalid email address"
                },
                "onlyLetter": {
        ...
        validateCall: function (caller, rules) {	// EXECUTE VALIDATION REQUIRED BY THE USER FOR THIS FIELD
            ...
            function _required(caller, rules) {   // VALIDATE BLANK FIELD
                ...
                if (callerType == "text" || callerType == "password" || callerType == "textarea") {
                    ...
                    //#A NR:020310 - raise an validation error if control has blank value or any default value.
                    // but dont raise an error if id = 'AuditObjectionAction'
                    ////////////////////////////////			
                    //				//#D SH:100909 - raise an validation error if control has blank value or any default value.
                    //				//if(!$(caller).val())
                    //				if((!$(caller).val()) || ($(caller).val() == $(caller).attr("defaultValue")))
                    //				{
                    ...
                    else if ($(caller).val() == $(caller).attr("defaultValue")) {
                        if ($(caller).attr("id") != 'AuditObjectionAction') {
                            $.validationEngine.isError = true;
                            promptText += $.validationEngine.settings.allrules[rules[i]].alertText + "<br />";
                        }
                    }
                        ...
                        success: function (data) {					// GET SUCCESS DATA RETURN JSON
                            ...
                            if (ajaxisError == "false") {			// DATA FALSE UPDATE PROMPT WITH ERROR;
                                ...
                                if ($.validationEngine.settings.allrules[customAjaxRule].alertTextOk) {	// NO OK TEXT MEAN CLOSE PROMPT	 			
                                    //#A JK:092309 - Commented as there is no requirement to show confirmation message if user exists.
