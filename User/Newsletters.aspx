<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Newsletters.aspx.cs" Inherits="User_pro" %>
        ...
        <div class="col-md-3"> 
          ...
          <div class="panel panel-default">
            <div class="panel-body profile">
              <div class="profile-image"> <img alt="" src="../ashi/images/christine.jpg"> </div>
              <div class="profile-data">
                <div class="profile-data-name">Weekly Market Recap for October 23, 2015</div>
              </div>
              <div class="profile-controls"> 
                  <a onclick="return ShowProfileModal(20241)" data-toggle="modal" class="profile-control-left"  href="#modal-regular-Profile">
                  <span   class="fa fa-info"></span></a> <a class="profile-control-right" target="_blank" href="../UserDocs/Weekly_Macro_Recap_for_October_23_2015.pdf"><i class="fa fa-download"></i></span></a> </div>
            </div>
            ...
            <div class="panel-body profile">
              <div class="profile-image"> <img alt="" src="../ashi/images/christine.jpg"> </div>
              <div class="profile-data">
                <div class="profile-data-name">Weekly Market Recap for October 16, 2015</div>
              </div>
              <div class="profile-controls"> 
                  <a onclick="return ShowProfileModal(20241)" data-toggle="modal" class="profile-control-left"  href="#modal-regular-Profile">
                  <span   class="fa fa-info"></span></a> <a class="profile-control-right" target="_blank" href="../UserDocs/Weekly_Macro_Recap_for_October_16_2015.pdf"><i class="fa fa-download"></i></span></a> </div>
            </div>
            <div class="panel-body">
              <div class="newsletter-info">
                <div class="col-md-6">
            ...
            <div class="panel-body profile">
              <div class="profile-image"> <img alt="" src="../ashi/images/christine.jpg"> </div>
              <div class="profile-data">
                <div class="profile-data-name">Weekly Market Recap for November 27 ,2015</div>
              </div>
              <div class="profile-controls"> 
                  <a onclick="return ShowProfileModal(20241)" data-toggle="modal" class="profile-control-left"  href="#modal-regular-Profile">
                  <span   class="fa fa-info"></span></a> <a class="profile-control-right" target="_blank" href="../UserDocs/Weekly_Macro_Recap_for_November_27_2015.pdf"><i class="fa fa-download"></i></span></a> </div>
            </div>
            <div class="panel-body">
              <div class="newsletter-info">
                <div class="col-md-6">
