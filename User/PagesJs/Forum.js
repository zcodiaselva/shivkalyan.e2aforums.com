...
function FillCategoryComboFilter() {
    ...
    if ($('#cmb_Categories').val() == -1 && varCategoryID == -1)
        return false;
...
function AddPostComments(varPostID) {
    if (mvarOccupationID == 0) {
        document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-danger'><i class='fa fa-warning'></i>  <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> Please update your profile to enjoy fully- featured 14 days free trial . <a href='Profile.aspx'>Click here</a></div>";
        return false;
    }
   else if (mvarOccupationID == 7) {
        document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-danger'><i class='fa fa-warning'></i>  <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> You are not athunticated. </div>";
        return false;
    }

else  if (varPlanActiveL != "YES") {
        document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-danger'><i class='fa fa-warning'></i>  <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> Your plan has expired. Kindly purchase a plan soon, <a href='../Pricing.aspx' target='_blank'> Click Here</a></div>";
        return false;
    }
    else {
        ...
        $.post("Ajax/AjaxUser.aspx",
                {
                    ...
                    function (VarResponseData) {
                        ...
                        if (VarResponseData == "SUCCESS" || VarResponseData == "success") {
                            ...
                            document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-success'> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong> <i class='fa fa-check'></i> Success!</strong> Comment posted successfully</div>"
                ...
                function (VarResponseData) {
                    ...
                    if (VarResponseData == "SUCCESS") {
                       ...
                       // toastr["success"]("Message sent successfully");
                        document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-success'><i class='fa fa-check'></i>  <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> Message sent successfully.</div>";
                        $('#btn_CloseMsg').click();
...
function PostTopicComments(pvarIsUrl) {
    ...
    if (mvarOccupationID == 7) {
        ...
        if ($('#default-textarea').val().trim() == '') {
            ...
            document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-danger'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong><i class='fa fa-warning'></i> Warning!</strong> Please enter text</div>";
            return false;
        }
            ...
            if ($('#filUpload1').val() != "" || $('#filUpload2').val() != "" || $('#filUpload3').val() != "") {
                ...
                document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-danger'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong><i class='fa fa-warning'></i> Warning!</strong> Please select Image.</div>";
                return false;
            }
        }
            ...
            if ($('#txtVideoURL').val() != '') {
                ...
                if (url!='') {
                    ...
                    $.post("Ajax/AjaxUser.aspx",
                            {
                                ...
                                function (VarResponseData) {
                                    if (VarResponseData == "SUCCESS" || VarResponseData == "success") {
                                        GetForumPosts(varTopicID, 'li_' + varTopicID);
                                        document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-success'> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong> <i class='fa fa-check'></i> Success!</strong> Post added successfully</div>";
                 ...
                 document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-danger'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong><i class='fa fa-warning'></i> Warning!</strong> Please enter youtube URL</div>";
                return false;
            }
        }
        else {
                      ...
                      if (varResponseData != "") {
                          ...
                          if ((varResponseData == "SUCCESS") || (varResponseData == "success")) {
                             // toastr["success"]("Post liked successfully");
                              document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-success'> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong> <i class='fa fa-check'></i> Success!</strong> Post liked successfully.</div>";
                  ...
                  function (varResponseData) {
                      ...
                      if (varResponseData != "") {
                          ...
                          if ((varResponseData == "SUCCESS") || (varResponseData == "success")) {
                              ...
                              document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-success'> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong> <i class='fa fa-check'></i> Success!</strong> Post unliked successfully</div>";
...
//    var ckdata = CKEDITOR.instances['txtDesc'].getData();
//    var varIsFlagged = "";
//    if (varCategoryID == -1) {
...
function PostTopicUrl(pvarIsUrl) {
    if (mvarOccupationID == 0) {
        ...
        if (re.test(txt)) {
            ...
            document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-danger'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong><i class='fa fa-warning'></i> Warning!</strong> Please enter valid url. </div>";
        }
        return false;
    }
...
function LikeTopic(pvarTopicID) {
    ...
    if (mvarOccupationID == 0) {
        //toastr["error"]("Please update your profile to enjoy fully- featured 14 days free trial . <a href='Profile.aspx'>Click here</a>");
        document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-danger'><i class='fa fa-warning'></i>  <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> Please update your profile to enjoy fully- featured 14 days free trial . <a href='Profile.aspx'>Click here</a></div>";
        return false;
    }
    else if (mvarOccupationID == 7) {
                  ...
                  function (varResponseData) {
                      ...
                      if (varResponseData != "") {
                          ...
                          if ((varResponseData == "SUCCESS") || (varResponseData == "success")) {
                              ...
                              document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-success'> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong> <i class='fa fa-check'></i> Success!</strong> Topic liked successfully.</div>";
...
function UnlikeTopic(pvarTopicID) {
    ...
    if (mvarOccupationID == 0) {
        document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-danger'><i class='fa fa-warning'></i> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> Please update your profile to enjoy fully- featured 14 days free trial . <a href='Profile.aspx'>Click here</a> <a href='Profile.aspx'></a></div>";
        return false;
    }
    else if (mvarOccupationID == 7) {
        document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-danger'><i class='fa fa-warning'></i>  <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> You are not athunticated.</div>";
                  ...
                  function (varResponseData) {
                      ...
                      if (varResponseData != "") {
                          ...
                          if ((varResponseData == "SUCCESS") || (varResponseData == "success")) {
                              ...
                              document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-success'> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong> <i class='fa fa-check'></i> Success!</strong>Topic unliked successfully.</div>";
...
function AddnewTabInForum(pvarTopicID, pvarTopic, pvarCategoryID, pvarNotificationID) {
    ...
    if ($("#tabs").find("li[name='li_" + pvarTopicID + "']").length == 0) {
        ...
        $("#tabs li").removeClass('active');
        $("#tabs").append("<li title='" + varTopicName + "' id='li_" + pvarTopicID + "'   name='li_" + pvarTopicID + "' class='sahil-active'><a class=\"enable-tabs\" onclick='return showTab(" + pvarTopicID + ");'  id='" +
                pvarTopicID + "' href='#'>" + varShortTopicName +
                 "</a><a  data-toggle='pill' href='#content' title='Click to close the tab'><image  src=\"img/cross-script.png\" style='top:-40px;left:" + pos + "px;position:absolute;height:10px;width:10px;' onclick='return RemoveTab(\"li_" + pvarTopicID + "\");'></a></li>");
        console.log("1");
        GetForumPosts(pvarTopicID, 'li_' + pvarTopicID);
                    ...
                    function (varResponseData) {
                        ...
                        if (varResponseData != "") {
                            ...
                            if ((varResponseData == "SUCCESS") || (varResponseData == "success")) {
                                ...
                                document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-success'> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong> <i class='fa fa-check'></i> Success!</strong> Post Deleted successfully</div>";
                                GetForumPosts(varTopicID, 'li_' + varTopicID);
                        ...
                        if (varResponseData != "") {
                            ...
                            if ((varResponseData == "SUCCESS") || (varResponseData == "success")) {
                              //  toastr["success"]("Comment Deleted successfully");
                                document.getElementById("validation-msg-container").innerHTML = "<div class='alert alert-success'> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong> <i class='fa fa-check'></i> Success!</strong> Comment Deleted successfully</div>";
