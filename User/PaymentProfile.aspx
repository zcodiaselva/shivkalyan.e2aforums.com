<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaymentProfile.aspx.cs" Inherits="User_pro" %>
    ...
    <!-- side Menu Control End  -->
     <div class="page-content-wrap"> 
      <div class="inner-content-wrap"> 
                <!-- Page content -->
             <!-- Tab Content -->
          <h1>Payment Recurring Profile Details</h1>
...
<!-- Modal -->
<div id="payment-recurring" class="recurring modal fade" role="dialog">
...
<div class="row">
                <div class="col-md-4">
                  <div class="invoice-address">
                    ...
                    <p><span id="pFull_Name" readonly="readonly"> </span> </p>
                    <p><strong>Email:</strong> <span id="pEMail" readonly="readonly"></span> </p>
                  </div>
                    ...
                    <table class="table table-striped">
                      <tbody>
                        <tr>
                          ...
                          <td class="text-right"> <span id="ptxn_type" readonly="readonly"></span></td>
                        </tr>
                        <tr>
                          <td> Payer ID :</td>
                          <td class="text-right"> <span id="ppayer_id" readonly="readonly"></span></td>
                        </tr>
                        <tr>
                          <td> Payer Full Name :</td>
                          <td class="text-right"> <span id="pbuy_FullName" readonly="readonly"></span></td>
                        </tr>
                        <tr>
                          <td> Payer Email :</td>
                          <td class="text-right"> <span id="ppayer_email" readonly="readonly"></span></td>
                        </tr>
                        <tr>
                          <td>Payment Response Date time :</td>
                          <td class="text-right"> <span id="ppay_res_date" readonly="readonly"></span></td>
                        </tr>
                        <tr>
                          <td>Response:</td>
                          <td class="text-right"> <span id="pstr_out_Response" readonly="readonly"></span></td>
                        </tr>
                        <tr>
                          <td>Requset ID :</td>
                          <td class="text-right"> <span id="preq_id" readonly="readonly"></span></td>
                        </tr>
                        <tr>
                          <td>Payment Amount :</td>
                            <td class="text-right"> <span id="PAmount" readonly="readonly"></span></td>
                        </tr>
                           <tr>
                          <td>Rucurring Period :</td>
                            <td class="text-right"> <span id="Prec_time" readonly="readonly"></span></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
